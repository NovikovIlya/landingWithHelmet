...
export const HeroSection = (): JSX.Element => {
  return (
    <section 
      className="relative w-full h-[100vh] flex items-end bg-dark bg-cover"
      style={{
        backgroundImage: 'url(/BackgroundFin.svg)',
        // Safari фиксы
        ...
        <div className="relative w-full min-h-[60vh] h-full">
          <div className="flex flex-col lg:flex-row items-center justify-center bg-cover bg-center bg-no-repeat h-full">
            ...
            >
              <BlurFade delay={1.0} className="">
                <img 
                  src="/imgInterfacePieces.png" 
                  alt="UI Cards" 
                  className="w-full h-[260px] sm:h-full"
                  style={{
                    // Safari оптимизация для изображений
